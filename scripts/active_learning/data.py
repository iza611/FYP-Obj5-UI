...
class Data:
    ...
    def split_to_train_and_test(self):
        ...
        self.input_train, self.input_test, self.output_train, self.output_test = train_test_split(
            self.input_embeddings, self.outputY, test_size=0.2)

    def split_to_train_and_test_annotation_id(self):
        seed(7)
        self.input_train_annotation_id, self.input_test_annotation_id, self.output_train_annotation_id, self.output_test_annotation_id = train_test_split(
            self.input_annotation_id, self.outputY, test_size=0.2)
